...
namespace GestionProjects.Domain.Models
{
    ...
    public class CharteProjet : EntiteAudit
    {
        ...
        public Utilisateur ChefProjet { get; set; } = null!;
        ...
        // Signatures électroniques (base64 PNG capturées dans l'application)
        public string? SignatureImageCP { get; set; }
        public DateTime? DateSignatureImageCP { get; set; }
        public string? SignatureImageSponsor { get; set; }
        public DateTime? DateSignatureImageSponsor { get; set; }
        public string? SignatureImageDSI { get; set; }
        public DateTime? DateSignatureImageDSI { get; set; }
