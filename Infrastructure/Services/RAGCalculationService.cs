...
namespace GestionProjects.Infrastructure.Services
{
    ...
    public class RAGCalculationService : IRAGCalculationService
    {
        ...
        private Task<List<TypeLivrable>> GetLivrablesObligatoiresPourPhaseAsync(PhaseProjet phase)
        {
            // Logique similaire à LivrableValidationService
            var livrables = phase switch
            {
                PhaseProjet.AnalyseClarification => new List<TypeLivrable>
                {
            ...
            return Task.FromResult(livrables);
        }
    }
}
